...
document.getElementById("p").innerHTML = "Sketch to be drawn: " + sketch;
...
function draw() {
    ...
    if (drawn_sketch == sketch) {
        answer_holder = "set"
        score++;
        document.getElementById('o').innerHTML = 'Score: ' + score;
    }
...
function check_sketch() {
    timer_counter++;
    document.getElementById("i").innerHTML = ' Timer: ' + timer_counter;
